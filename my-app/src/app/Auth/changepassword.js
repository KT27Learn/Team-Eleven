            ...
            if(!password) {
                ...
                try {
                    ...
                    if (user.result.password) {
                        ...
                        res = await axios.post('https://team-eleven-backend-da7fbaef930b.herokuapp.com/users/changepassword', {password: password, newPassword, email: user.result.email}, {
                        })
                    } else {
                        res = await axios.post('https://team-eleven-backend-da7fbaef930b.herokuapp.com/users/setpassword', {password: password, email: user.result.email}, {
                        })
                    }
