...
import StudySummary from "./components/study-summary-component";
  ...
  return (
    <Router>
      <div className="container">
        ...
        <Route path="/summary" exact component={StudySummary} />
        ...
        <Route
          path="/create-studymethod"
          exact
          component={CreateStudyMethods}
        />
      </div>
    </Router>
  );
