...
export default class EditStudyMethod extends Component {
    ...
    onSubmit(e) {
        ...
        axios.post('http://localhost:5000/library/update/'+ this.props.match.params.id, studymethod)
        ...
        return (
          <div>
              ...
              <form onSubmit={this.onSubmit}>
                  ...
                  <div className="form-group">
                  <input type="submit" value="Edit Study Method" className="btn btn-primary" />
                  </div>
              </form>
              </div>
        );
